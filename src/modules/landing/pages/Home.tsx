...
import { TypewriterEffect } from "@/components/custom/typewriter-effect";
import { motion } from "framer-motion";
import { AnimatedGradientText } from "@/components/custom/animated-gradient";

import darkscreenshot from "@/assets/screenshots/Dark_screenshot.png"
import lightScreenShot from "@/assets/screenshots/Light_screenshot.png";
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center  text-center lg:text-left justify-center gap-4 sm:gap-6 w-full h-full  lg:px-8 xl:px-16">
        <motion.h1 className="text-5xl md:text-5xl lg:text-5xl font-bold">
